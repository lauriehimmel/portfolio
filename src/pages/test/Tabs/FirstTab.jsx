...
const FirstTab = () => {
  return (
    <div className="FirstTab">
      ...
      <br />
      <p>Inspired by the 90s and my one-eyed dog Roux, it takes you back to a simpler time when phones had cords and apps were just what came before entrees.</p>
      </div>
    </div>
  );
};
